...
ggplot(data = champsfreq1, aes(x = reorder(champs1, -Freq), y = Freq)) + geom_bar(stat = "identity", aes(fill = champs1)) + 
...
ggplot(data = champsfreq2, aes(x = reorder(champs2, -Freq), y = Freq)) + geom_bar(stat = "identity", aes(fill = champs2)) + 
  theme_minimal() + theme(axis.text.x = element_text(angle = 90), legend.position = "none") + 
...
ggplot(data = champsfreq3, aes(x = reorder(champs3, -Freq), y = Freq)) + geom_bar(stat = "identity", aes(fill = champs3)) + 
  theme_minimal() + theme(axis.text.x = element_text(angle = 90), legend.position = "none") + 
...
#### 2017/18 Sim Upsets vs 2010-2019 (by Round and Format) ####
...
#### 2017/18 Sim Long Series vs 2010-2019 (by Round and Format) ####
